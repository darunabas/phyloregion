...
## 1 picante     113.87ms 120.72ms      8.14    59.5MB    14.7 
## 2 hilldiv     930.26ms 930.26ms      1.07  170.22MB     6.45
## 3 pez         136.01ms 153.13ms      6.63   60.78MB    11.6 
## 4 phyloregion   3.26ms   3.79ms     64.2     1.83MB     3.29
```
...
![plot of chunk phylo_diversity](intro-phylo_diversity-1.png)
...
##   expression       min   median `itr/sec` mem_alloc `gc/sec`
##   <bch:expr>  <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
## 1 pez            1.18s    1.18s     0.846  498.93MB     5.08
## 2 phyloregion   3.56ms   3.67ms   255.       1.06MB     3.98
```
...
![plot of chunk phylo_endemism](intro-phylo_endemism-1.png)
...
##   expression       min   median `itr/sec` mem_alloc `gc/sec`
##   <bch:expr>  <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
## 1 phyloregion  795.1µs  853.9µs    1143.   395.69KB     4.33
## 2 betapart     806.5µs  851.4µs    1056.   601.23KB     6.42
## 3 vegan        659.4µs  753.9µs    1127.     1.02MB    15.5 
## 4 BAT           37.8ms   39.2ms      23.7   31.76MB    13.5
```
...
![plot of chunk beta_diversity](intro-beta_diversity-1.png)
...
##   expression       min   median `itr/sec` mem_alloc `gc/sec`
##   <bch:expr>  <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
## 1 picante        3.74s    3.74s     0.267    1.24GB    1.34 
## 2 betapart       3.18s    3.18s     0.315    1.24GB    0.944
## 3 BAT             1.6s     1.6s     0.624  207.39MB    0.624
## 4 phyloregion   4.77ms   4.85ms   201.       1.07MB    0
```
...
![plot of chunk phylobeta](intro-phylobeta-1.png)
...
##  [5] LC_MONETARY=de_AT.UTF-8    LC_MESSAGES=de_AT.UTF-8    LC_PAPER=de_AT.UTF-8       LC_NAME=C                 
...
##  [1] pez_1.2-0         BAT_2.0.0         hilldiv_1.5.1     picante_1.8.1     nlme_3.1-144      vegan_2.5-6      
##  [7] lattice_0.20-40   permute_0.9-5     betapart_1.5.1    phyloregion_1.0.0 ggplot2_3.3.0     bench_1.1.1      
## [13] Matrix_1.2-18     ape_5.3           knitr_1.28       
## 
## loaded via a namespace (and not attached):
##   [1] backports_1.1.5         Hmisc_4.3-1             BDgraph_2.62            fastmatch_1.1-0        
##   [5] plyr_1.8.6              igraph_1.2.4.2          sp_1.4-1                splines_3.6.3          
##   [9] crosstalk_1.0.0         digest_0.6.25           htmltools_0.4.0         fansi_0.4.1            
##  [13] phytools_0.6-99         magrittr_1.5            checkmate_2.0.0         tensor_1.5             
##  [17] cluster_2.1.0           ks_1.11.7               fastcluster_1.1.25      pdist_1.2              
##  [21] prettyunits_1.1.1       jpeg_0.1-8.1            colorspace_1.4-1        xfun_0.12              
##  [25] dplyr_0.8.5             crayon_1.3.4            jsonlite_1.6.1          spatstat.data_1.4-3    
##  [29] spatstat_1.63-3         survival_3.1-8          phangorn_2.5.5          glue_1.3.1             
##  [33] apTreeshape_1.5-0       polyclip_1.10-0         gtable_0.3.0            geiger_2.0.6.4         
##  [37] MatrixModels_0.4-1      webshot_0.5.2           maps_3.3.0              SparseM_1.78           
##  [41] abind_1.4-5             scales_1.1.0            mvtnorm_1.1-0           miniUI_0.1.1.1         
##  [45] Rcpp_1.0.3              plotrix_3.7-7           xtable_1.8-4            progress_1.2.2         
##  [49] htmlTable_1.13.3        magic_1.5-9             foreign_0.8-75          subplex_1.6            
##  [53] mclust_5.4.5            deSolve_1.28            Formula_1.2-3           stats4_3.6.3           
##  [57] animation_2.6           htmlwidgets_1.5.1       RColorBrewer_1.1-2      lavaan_0.6-5           
##  [61] acepack_1.4.1           farver_2.0.3            pkgconfig_2.0.3         deldir_0.1-25          
##  [65] nnet_7.3-13             utf8_1.1.4              tidyselect_1.0.0        rlang_0.4.5            
##  [69] manipulateWidget_0.10.1 reshape2_1.4.3          later_1.0.0             munsell_0.5.0          
##  [73] tools_3.6.3             cli_2.0.2               ade4_1.7-15             FD_1.0-12              
##  [77] fdrtool_1.2.15          evaluate_0.14           geometry_0.4.5          stringr_1.4.0          
##  [81] fastmap_1.0.1           goftest_1.2-2           yaml_2.2.1              rgl_0.100.50           
##  [85] purrr_0.3.3             glasso_1.11             pbapply_1.4-2           quantreg_5.54          
##  [89] whisker_0.4             mime_0.9                profmem_0.5.0           compiler_3.6.3         
##  [93] rstudioapi_0.11         beeswarm_0.2.3          png_0.1-7               e1071_1.7-3            
##  [97] ggsignif_0.6.0          spatstat.utils_1.17-0   clusterGeneration_1.3.4 huge_1.3.4             
## [101] tibble_2.1.3            pbivnorm_0.6.0          stringi_1.4.6           highr_0.8              
## [105] qgraph_1.6.5            cubature_2.0.4          rgeos_0.5-2             psych_1.9.12.31        
## [109] vctrs_0.2.4             pillar_1.4.3            lifecycle_0.2.0         combinat_0.0-8         
## [113] caper_1.0.1             data.table_1.12.8       corpcor_1.6.9           raster_3.0-12          
## [117] httpuv_1.5.2            R6_2.4.1                latticeExtra_0.6-29     promises_1.1.0         
## [121] KernSmooth_2.23-16      gridExtra_2.3           vipor_0.4.5             codetools_0.2-16       
## [125] rcdd_1.2-2              MASS_7.3-51.5           gtools_3.8.1            assertthat_0.2.1       
## [129] rjson_0.2.20            withr_2.1.2             mnormt_1.5-6            expm_0.999-4           
## [133] mgcv_1.8-31             parallel_3.6.3          hms_0.5.3               quadprog_1.5-8         
## [137] grid_3.6.3              rpart_4.1-15            tidyr_1.0.2             coda_0.19-3            
## [141] class_7.3-15            rmarkdown_2.1           nls2_0.2                FSA_0.8.30             
## [145] hypervolume_2.0.12      d3Network_0.5.2.1       ggpubr_0.2.5            scatterplot3d_0.3-41   
## [149] numDeriv_2016.8-1.1     shiny_1.4.0             base64enc_0.1-3         ggbeeswarm_0.6.0
```
